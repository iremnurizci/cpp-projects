...
int main(void)
{
	...
	while (l) {
		...
		if (choice == 'p') {
			...
			int Player(&playerScore, playerPrizes, &prizeCount, &playerName, &playerPosition);

			printf("Enter board size: ");
			scanf("%d", &size);

			int playGame(size, &playerScore, playerPrizes, &prizeCount, &playerName, &playerPosition);
